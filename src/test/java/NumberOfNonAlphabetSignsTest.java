...
public class NumberOfNonAlphabetSignsTest {
    ...
    public static final String testMessage = "It is a truth universally acknowledged, that a single man in possession\n" +
    ...
    public void numberOfNonAlphabetSignsTest() {
        NumberOfNonAlphabetSigns number = new NumberOfNonAlphabetSigns(testMessage);
